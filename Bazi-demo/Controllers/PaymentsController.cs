...
namespace Bazi_demo.Controllers
{
    public class PaymentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Amount,Date")] Payment payment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Amount,Date")] Payment payment)
        {
            if (id != payment.Id)
            {
                return NotFound();
